...
/** Utility functions used by the Advantage Qt UI.
 */
namespace GUIUtil
{
...
// Render Advantage addresses in monospace font
...
// Parse "advantage:" URI into recipient object, return true on successful parsing
