...
#ifndef BITCREDIT_QT_WALLETMODEL_H
#define BITCREDIT_QT_WALLETMODEL_H
...
public:
    ...
    CAmount getBalance(const CCoinControl* creditControl = NULL) const;
    ...
    // prepare transaction for getting txfee before sending credits
    SendCoinsReturn prepareTransaction(WalletModelTransaction& transaction, const CCoinControl* creditControl = NULL);
    ...
    bool isMine(CBitcreditAddress address);
...
signals:
    ...
    void creditsSent(CWallet* wallet, SendCoinsRecipient recipient, QByteArray transaction);
...
#endif // BITCREDIT_QT_WALLETMODEL_H
