/********************************************************************************
** Form generated from reading UI file 'sendcreditsentry.ui'
**
...
#ifndef UI_SENDCREDITSENTRY_H
#define UI_SENDCREDITSENTRY_H
...
public:
    ...
    QLabel *amountLabel;
    BitcreditAmountField *payAmount;
    QLabel *messageLabel;
    ...
    BitcreditAmountField *payAmount_is;
    ...
    BitcreditAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new BitcreditAmountField(SendCoins);
        ...
        payAmount_is = new BitcreditAmountField(SendCoins_InsecurePaymentRequest);
        ...
        payAmount_s = new BitcreditAmountField(SendCoins_SecurePaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Advantage address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the Advantage: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Advantage network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
