...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcreditUnits::USDA)
    {
    }
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, balance - immatureBalance, false, BitcreditUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, BitcreditUnits::separatorAlways));
    ui->labelImmature->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, BitcreditUnits::separatorAlways));
    ui->labelAnonymized->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, BitcreditUnits::separatorAlways));
    ui->labelTotal->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance, false, BitcreditUnits::separatorAlways));


    ui->labelWatchAvailable->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, BitcreditUnits::separatorAlways));
    ui->labelWatchPending->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, BitcreditUnits::separatorAlways));
    ui->labelWatchImmature->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, BitcreditUnits::separatorAlways));
    ui->labelWatchTotal->setText(BitcreditUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, BitcreditUnits::separatorAlways));
...
void OverviewPage::updateObfuscationProgress()
{
    ...
    QString strAnonymizeAdvantageAmount = BitcreditUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeAdvantageAmount * CREDIT, false, BitcreditUnits::separatorAlways);
    ...
    if (currentBalance == 0) {
        ...
        strAnonymizeAdvantageAmount = strAnonymizeAdvantageAmount.remove(strAnonymizeAdvantageAmount.indexOf("."), BitcreditUnits::decimals(nDisplayUnit) + 1);
    ...
    if (nMaxToAnonymize > nAnonymizeAdvantageAmount * CREDIT) nMaxToAnonymize = nAnonymizeAdvantageAmount * CREDIT;
    ...
    if (nMaxToAnonymize >= nAnonymizeAdvantageAmount * CREDIT) {
        ...
        QString strMaxToAnonymize = BitcreditUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, BitcreditUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                              .arg(strAnonymizeAdvantageAmount)
                                              .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), BitcreditUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                             QString(BitcreditUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::toggleObfuscation()
{
    ...
    if (!fEnableObfuscation) {
        ...
        if (balance < minAmount) {
            QString strMinAmount(BitcreditUnits::formatWithUnit(nDisplayUnit, minAmount));
            QMessageBox::warning(this, tr("Obfuscation"),
