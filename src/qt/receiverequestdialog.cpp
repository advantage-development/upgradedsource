...
#include "config/advantage-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitcreditURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + BitcreditUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
