...
private slots:
    ...
    void updateSwiftTX();
    void creditControlFeatureChanged(bool);
    void creditControlButtonClicked();
    void creditControlChangeChecked(int);
    void creditControlChangeEdited(const QString&);
    void creditControlUpdateLabels();
    void creditControlClipboardQuantity();
    void creditControlClipboardAmount();
    void creditControlClipboardFee();
    void creditControlClipboardAfterFee();
    void creditControlClipboardBytes();
    void creditControlClipboardPriority();
    void creditControlClipboardLowOutput();
    void creditControlClipboardChange();
