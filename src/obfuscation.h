...
static const CAmount OBFUSCATION_COLLATERAL = (10 * CREDIT);
static const CAmount OBFUSCATION_POOL_MAX = (99999.99 * CREDIT);
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 USDA - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of advantage.
