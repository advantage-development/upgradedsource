...
#ifndef BITCREDIT_PRIMITIVES_TRANSACTION_H
#define BITCREDIT_PRIMITIVES_TRANSACTION_H
...
public:
    ...
    {
        // ppcredit: the credit stake transaction is marked with the first output empty
    ...
    bool GetCoinAge(uint64_t& nCoinAge) const;  // ppcredit: get transaction credit age
};
